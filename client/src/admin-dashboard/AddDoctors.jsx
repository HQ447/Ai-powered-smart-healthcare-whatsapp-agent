  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
      ...
      <div className="p-6 border-b border-slate-100 dark:border-slate-700">
        <h2 className="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Add New Doctor</h2>
      ...
      <div className="p-6 overflow-y-auto">
        <form onSubmit={handleSubmit}>
          {/* Abstract Header Decorative - removed to match Doctors.jsx consistency, we'll just keep it clean */}
          <div className="flex flex-col sm:flex-row items-center gap-6 mb-10">
              <div className="relative group">
                  <div className="w-24 h-24 rounded-full bg-white dark:bg-slate-800 p-1 shadow-md border border-slate-200 dark:border-slate-700">
